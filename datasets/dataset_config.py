...
dataset_config = {
    ...
    'pathmnist': {
        'path': join(_MEDIMNIST_DATA_PATH, 'pathmnist'),
        'resize': None,
        'pad': 4,
        'crop': 32,
        'flip': True,
    ...
    'organamnist': {
        'path': join(_MEDIMNIST_DATA_PATH, 'organamnist'),
        'resize': None,
        'pad': 4,
        'crop': 32,
        'flip': True,
    ...
    'bloodmnist': {
        'path': join(_MEDIMNIST_DATA_PATH, 'bloodmnist'),
        'resize': None,
        'pad': 4,
        'crop': 32,
        'flip': True,
    ...
    'tissuemnist': {
        'path': join(_MEDIMNIST_DATA_PATH, 'tissuemnist'),
        'resize': None,
        'pad': 4,
        'crop': 32,
        'flip': True,
